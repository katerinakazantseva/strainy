...
def sequential_phase(edges):
    empty_consensus_dict = {}
    flye_consensus = FlyeConsensus(bam, gfa, empty_consensus_dict, None)
    for i in range(len(edges)):
        cluster((i, flye_consensus))
    flye_consensus.print_cache_statistics()
    return flye_consensus.get_consensus_dict()
