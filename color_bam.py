...
infile = pysam.AlignmentFile(bam, "rb")
outfile = pysam.AlignmentFile("output/bam/coloredBAM_34.bam", "wb", template=infile)
...
pysam.samtools.index("output/bam/coloredBAM_34.bam","output/bam/coloredBAM_34.bai")